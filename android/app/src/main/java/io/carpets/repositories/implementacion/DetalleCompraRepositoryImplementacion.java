...
public class DetalleCompraRepositoryImplementacion implements DetalleCompraRepository {
    ...
    public Response save(DetalleCompra detalle) {
        ...
        String sql = "INSERT INTO detalle_compra (unidades, id_producto, id_compra, precio_unitario, sub_monto) VALUES (?, ?, ?, ?, ?)";
        ...
        try (Connection conn = ConfiguracionBaseDatos.getConnection();
            ...
            stmt.setDouble(5, detalle.getUnidades() * detalle.getPrecioUnitario());
    ...
    public Response update(DetalleCompra detalle) {
        Response response = new Response();
        String sql = "UPDATE detalle_compra SET unidades=?, id_producto=?, id_compra=?, precio_unitario=?, sub_monto=? WHERE id_detalle_compra=?";
     ...
     * @return Response<DetalleCompra> con los datos obtenidos o error
     */
    @Override
     ...
     * @return Response<List<DetalleCompra>> con la lista de detalles o error
     */
    @Override
     ...
     * @return Response<List<DetalleCompra>> con todos los detalles o error
     */
    @Override
